...
const performRequest = async (ticketNum) => {
    try {
        ...
        const urlPutRequest = 'https://cab.autoinline.com/api/ticket_credits/'; // Замените на ваш URL PUT запроса
        const headersPutRequest = {
            'Host': 'cab.autoinline.com',
            'Sec-Ch-Ua': '"Chromium";v="125", "Not.A/Brand";v="24"',
            'Accept': 'application/json, text/plain, */*',
            'Sec-Ch-Ua-Mobile': '?0',
        ...
        const responsePutRequest = await fetch(urlPutRequest, {
            method: 'PUT',
            headers: headersPutRequest,
            body: JSON.stringify(putRequestBody)
        });

        const responseData = await responsePutRequest.json();
